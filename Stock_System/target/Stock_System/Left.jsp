...
var tree = null;var root = new TreeNode('系统菜单');
           ...
           var fun6 = new TreeNode('股票查询');var fun7 = new TreeNode('股票查询', '/stock/stock.jsp', 'tree_node.gif', null, 'tree_node.gif', null);fun6.add(fun7);var fun8 = new TreeNode('', '/StockSpirit/actionServlet?actionCode=mycheck&methodCode=checkdisplay', 'tree_node.gif', null, 'tree_node.gif', null);fun6.add(fun8);root.add(fun6);
